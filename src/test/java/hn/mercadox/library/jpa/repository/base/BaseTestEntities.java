...
public class BaseTestEntities {
    ...
    protected hn.alturaforge.mercadox.library.entity.model.core.Order buildBaseOrder() {
        return hn.alturaforge.mercadox.library.entity.model.core.Order.builder()
                .id(hn.alturaforge.mercadox.library.entity.model.core.Order.generateId())
