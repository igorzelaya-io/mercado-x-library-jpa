...
import hn.alturaforge.mercadox.context.crypto.EncryptionAutoConfiguration;
import hn.alturaforge.mercadox.context.crypto.EnvVarMasterKeyService;
import hn.alturaforge.mercadox.context.crypto.MasterKeyProperties;
...
public class H2JpaTestConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emf.setPackagesToScan("hn.alturaforge.mercadox.library.entity");
